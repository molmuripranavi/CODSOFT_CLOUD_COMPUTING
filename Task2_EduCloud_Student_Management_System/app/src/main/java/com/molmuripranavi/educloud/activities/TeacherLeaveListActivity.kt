...
import com.molmuripranavi.educloud.adapters.TeacherLeaveAdapter
import com.molmuripranavi.educloud.models.LeaveRequest
import android.text.Editable
import android.text.TextWatcher
import com.google.android.material.textfield.TextInputEditText

class TeacherLeaveListActivity : AppCompatActivity() {

    private lateinit var recyclerView: RecyclerView
    private lateinit var adapter: TeacherLeaveAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = TeacherLeaveAdapter(leaveList)
    ...
    private fun loadLeaves() {
        ...
        query = when (statusFilter) {
            ...
            "Approved" -> query.whereIn("status", listOf("Teacher Approved", "Approved"))
